...
class TaxSaving extends StatelessWidget {
  const TaxSaving({Key? key}) : super(key: key);
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text('Save tax upto 46,800/-'),
                          ),
                          SizedBox(
                            height: 5,
                          ),
                          Container(
                            ...
                            child: Text('Lowest lock-in. 3 Years'),
                          ),
                          SizedBox(
                            height: 5,
                          ),
                          Container(
                            ...
                            child: Text('High returns than others'),
                          ),
                        ],
                      ),
                    )
