...
class IAmBeginnerScreen extends StatelessWidget {
  const IAmBeginnerScreen({Key? key}) : super(key: key);
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          AppLocalizations.of(context)!.iamabeginner,
                          style: TextStyle(
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('Low-High Risk Funds'),
                          ),
                          SizedBox(
                            height: 5,
                          ),
                          Container(
                            ...
                            child: Text('Funds as per investment tenure'),
                          ),
                        ],
                      ),
                    )
